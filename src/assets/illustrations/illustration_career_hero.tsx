          ...
          <m.div style={{ y: offsetY(-50) }}>
            <Label
              ...
              icon={
                <Image
                  alt="soap"
                  src="https://cdn-icons-png.flaticon.com/512/1656/1656569.png"
        ...
        <m.div style={{ x: offsetX(80), y: offsetY(80) }}>
          <Label
            ...
            icon={
              <Image
                alt="sanitizer"
                src="https://cdn-icons-png.flaticon.com/512/2847/2847921.png"
                sx={{ width: 48, height: 48 }}
              />
            }
          />
        ...
        <m.div style={{ y: offsetY(80) }}>
          <Label
            ...
            icon={
              <Image
                alt="mask"
                src="https://cdn-icons-png.flaticon.com/512/2833/2833174.png"
                sx={{ width: 48, height: 48 }}
              />
            }
          />
        ...
        <m.div style={{ y: offsetY(-60) }}>
          <Label
            ...
            icon={
              <Image
                alt="disinfectants"
                src="https://cdn-icons-png.flaticon.com/512/2473/2473084.png"
                sx={{ width: 48, height: 48 }}
              />
            }
          />
